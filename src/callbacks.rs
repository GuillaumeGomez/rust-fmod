...
use enums::*;
    ...
    pub type DspReadCallback = Option<fn(dsp_state: &dsp::DspState, in_buffer: &Vec<f32>, out_buffer: &Vec<f32>) -> fmod::Result>;
    ...
    pub type DspGetParamCallback = Option<fn(dsp_state: &dsp::DspState, index: i32, value: f32, value_str: &str) -> fmod::Result>;
